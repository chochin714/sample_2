...
<body>
<h2>案件承認画面</h2>
	<form:form action="caseApproval" method="POST" modelAttribute="casesModel">
		...
		承認状態<br>${casesModel.approval }<br>
		<br>
		<form:hidden path="caseId" value="${casesModel.caseId }" />
		<input type="submit" name="back" value="戻る">
		<input type="submit" name="dismiss" value="取り消す">
		<input type="submit" name="approval" value="承認する">
	</form:form>
</body>
</html>