...
<body>
	<h2>案件詳細画面</h2>
	<form:form action="caseDetail" method="POST" modelAttribute="casesModel">
	...
	<form:form action="caseSuggestion" >
	<input type="submit" path="" value="人員提案"/>
	</form:form>
	
	<form:form action="caseContact" >
	<input type="submit" path="" value="問い合わせ"/>
	</form:form>
</body>
</html>